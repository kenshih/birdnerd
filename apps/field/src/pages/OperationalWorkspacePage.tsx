...
export default function OperationalWorkspacePage({ onHome }: { onHome: () => void }) {
  ...
  return <main style={styles.page}>
    ...
    <section style={styles.status}><strong>{access.workspace_name}</strong><span>{formatSyncStatus(status)}</span><button type="button" onClick={() => void synchronize(true)}>Sync now</button></section>
