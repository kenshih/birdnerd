# Changelog archive — through 2026-04-12

Older BirdNerd changelog entries, archived from [CHANGELOG.md](../../CHANGELOG.md) on 2026-06-12 to keep the active changelog short. Covers the monorepo migration (Field 0.21.x), Shared/Field 0.22.0, and OCR 0.1.0–0.4.1.
