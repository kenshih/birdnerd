...
export type EventPayloadByType = {
  ...
  "station.created": { "station_id": string; "fields"?: { "name"?: string | null; "agency_code"?: string | null } }
  "station.deactivated": { "station_id": string }
  "station.fields-amended": { "station_id": string; "fields": { "name"?: string | null; "agency_code"?: string | null } }
...
export type EventPayloadByTypeAndVersion = {
  ...
  "station.created": { 1: { "station_id": string; "fields"?: { "name"?: string | null; "agency_code"?: string | null } } }
  "station.deactivated": { 1: { "station_id": string } }
  "station.fields-amended": { 1: { "station_id": string; "fields": { "name"?: string | null; "agency_code"?: string | null } } }
...
const EVENT_PAYLOAD_SCHEMAS: Readonly<Record<EventType, Readonly<Record<number, unknown>>>> = {
  ...
  "station.created": { 1: {"$schema":"https://json-schema.org/draft/2020-12/schema","title":"station.created v1","type":"object","required":["station_id"],"properties":{"station_id":{"type":"string","format":"uuid","pattern":"^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$"},"fields":{"type":"object","properties":{"name":{"oneOf":[{"type":"string"},{"const":null}]},"agency_code":{"oneOf":[{"type":"string","pattern":"^[A-Z]{4}$"},{"const":null}]}},"additionalProperties":false}},"additionalProperties":false} },
  ...
  "station.fields-amended": { 1: {"$schema":"https://json-schema.org/draft/2020-12/schema","title":"station.fields-amended v1","type":"object","required":["station_id","fields"],"properties":{"station_id":{"type":"string","format":"uuid","pattern":"^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$"},"fields":{"type":"object","properties":{"name":{"oneOf":[{"type":"string"},{"const":null}]},"agency_code":{"oneOf":[{"type":"string","pattern":"^[A-Z]{4}$"},{"const":null}]}},"additionalProperties":false}},"additionalProperties":false} },
